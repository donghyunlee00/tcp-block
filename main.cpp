...
{
    u_char *bwd_packet_ = (u_char *)malloc(packet_size + 10);
    ...
    bwd_packet->ip_.ip_len = htons(sizeof(libnet_ipv4_hdr) + sizeof(libnet_tcp_hdr) + 10);
    ...
    memcpy(bwd_packet->msg, "blocked!!!", 10);
    ...
    bwd_tcp_buffer.psd_.tcpl = htons(sizeof(libnet_tcp_hdr) + 10);
    memcpy(&bwd_tcp_buffer.tcp_, &bwd_packet->tcp_, sizeof(libnet_tcp_hdr) + 10);
